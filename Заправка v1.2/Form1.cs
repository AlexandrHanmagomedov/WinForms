...
namespace DZ_1_8 {
    public partial class Form1 : Form {
        ...
        double[] oil = { 40.00, 45.00, 50.00, 35.00, 30.00 };
        int tempTimer = 0;
        ...
        private void Form1_FormClosing ( object sender, FormClosingEventArgs e ) {
            if ( PayTotal == 0 ) {
                ...
                MessageBox.Show ( $"Общие продажи за {DateTime.Now.ToShortDateString ( )} = {Math.Round ( PayTotal, 2 )} руб.", "Выход", MessageBoxButtons.OK, MessageBoxIcon.Information );
            }
        }

        private void Timer_Tick_OLD ( object sender, EventArgs e ) {
            System.Windows.Forms.Timer s = sender as System.Windows.Forms.Timer;
            tempTimer++;
            if ( tempTimer == 5 ) {
        ...
        private void toolStripStatusLabelTimeOrDate_Click ( object sender, EventArgs e ) {
